        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span8" placeholder="Bank Name" id="bank_name" type="text"
                       ...
                       value="{{ $bank->bank_name }}" autocomplete="bank_name" autofocus>
                @error('bank_name')
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span8" placeholder="Address Line 1" id="address_line1" type="text"
                       ...
                       value="{{ $bank->address_line1 }}" required autocomplete="address_line1" autofocus>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span8" placeholder="Address Line 2" id="address_line2" type="text"
                       ...
                       value="{{ $bank->address_line2 }}" required autocomplete="address_line2" autofocus>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span8" placeholder="City" id="city" type="text"
                       ...
                       value="{{ $bank->city }}" required autocomplete="city" autofocus>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span8" placeholder="PostCode" id="postcode" type="text"
                       ...
                       value="{{ $bank->postcode }}" required autocomplete="postcode" autofocus>
